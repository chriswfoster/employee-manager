    ...
    return (
      <div id="app">
        ...
        <div className="main-container">
          <EmployeeList employees={this.state.employees} selecteEmployee={this.selectEmployee.bind(this)}/> // bind is new?
          <EmployeeEditor selected={this.state.selectedEmployee} refreshList={this.refresh.bind.apply(this)}/> 
        </div>
      </div>
    )
  }
